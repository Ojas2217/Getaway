...
export default function Footer() {
  return (
    ...
    <footer className="foot bg-gray/55 backdrop-blur-lg flex items-center justify-between w-auto h-24 text-white border-t border-white">
      <div className="icons flex space-x-2 pl-6">
        ...
        <a href ="https://www.linkedin.com/in/ojas-pandey-06a318240/"><FaLinkedin className="l size-12 hover:scale-120 transition"/></a>
      </div>
